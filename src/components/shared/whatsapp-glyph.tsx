 ...
 *
 * Inlined rather than taken from an icon set so the mark is correct — a
 * generic speech bubble reads as "chat", not as "WhatsApp", and
 * recognisability is the entire point of every control that uses it. Shared
 * by the floating button and the labelled WhatsApp buttons so the mark is
 * drawn once.
 */
